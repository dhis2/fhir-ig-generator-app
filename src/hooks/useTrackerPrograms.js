  ...
  programs: {
    ...
    params: {
      ...
      fields: [
        ...
        "programStages[name,description,repeatable,programStageDataElements[compulsory,dataElement[name,shortName,formName,displayName,valueType,optionSet[name,options[code,name]]]]]",
      ]
    },
  },
};
