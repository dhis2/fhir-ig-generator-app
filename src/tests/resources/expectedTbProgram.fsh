...
* enrollmentDate 1..1 date "Start of treatment date. The enrollment date is the date the patient officially starts being monitored under the program."
* incidentDate 0..1 date "Start of treatment date. The incident date is a key date which is chosen as the base date from which visit schedules and notifications are calculated."
